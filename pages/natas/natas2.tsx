const natas2 = () => {
  return (
    <div>
      ...
      page is a little more accurate. So I noticed that the pixel
      was located in the files folder, so I added that to the 
      website link and amazingly, a text file was there.
    </div>
  )
}
